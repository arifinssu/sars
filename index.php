...
<head>
  ...
  <meta name="description" content="Sistem Antrian Rumah Sakit">
  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>Sistem Antrian Rumah Sakit</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="ambil-antrian" class="btn btn-success rounded-pill px-4 py-2">
